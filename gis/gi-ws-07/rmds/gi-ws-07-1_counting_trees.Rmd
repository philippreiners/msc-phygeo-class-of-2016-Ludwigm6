...
```
***  
Als erste Schätzung ist das Ergebnis Ok, da die meisten Bäume auch wirklich in Gebieten erkannt werden, die offensichtlich Wälder sind. Um die Artefakte außerhalb der Wälder zu bereinigen könnte man das Ergebniss mit einer Landnutzungsklassifikation filtern. Außerdem könnte man höhe und breite der Bäume im Modell (Filtergröße) dynamisch an diese Klassifikation je nach Waldart anpassen.  
***  
***  
